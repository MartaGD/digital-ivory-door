    ...
    <section className="wedding-section" style={{ background: "hsl(var(--background))" }}>
      <ScrollReveal className="w-full max-w-lg mx-auto text-center">
        ...
        <a
          ...
          className="inline-flex items-center gap-2 px-6 py-3 rounded-full font-display text-sm tracking-wider uppercase transition-all duration-300 hover:scale-105"
          style={{
            background: "#1DB954",
            color: "#fff",
          }}
